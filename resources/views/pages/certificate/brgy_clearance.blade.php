        ...
        <tr>
            <td style="padding: 10px;">
                <p style="padding: 0; margin: 0;">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that <b>{{ $data["title"] }} {{ $data["fullname"] }}</b>, <b>{{ $data["age"] }}</b> years old, a resident of <b>{{ $data["address"] }}</b>, East Bajac – Bajac, Olongapo City is a qualified availed of RA 11261 or the First Time Jobseekers Act of 2019.
                </p>
            </td>
        </tr>
        <tr>
